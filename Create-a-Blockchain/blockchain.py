...
#todo -> Part 1 - building a blockchain
...
#todo ->  Part 2 - Mining our blockchain
...
def mine_block():
    ...
    response = {'message': "congratulation, you just mined the block !",
               'index': block['index'],
...
# todo -> getting the full blockchain
